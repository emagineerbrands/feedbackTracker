import { Component, OnInit, OnDestroy, AfterViewInit,ElementRef, ViewChild, Directive, EventEmitter, Output, HostListener} from '@angular/core';
...
@Component({
  ...
  styleUrls: ['./returns-order-search.component.css']
})
