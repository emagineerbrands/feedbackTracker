...
import { ColDef, GridApi, Column, GridReadyEvent, IServerSideDatasource, IServerSideGetRowsRequest, RowModelType, ModuleRegistry, IDatasource, IGetRowsParams, ColGroupDef, GridOptions  } from 'ag-grid-community';
