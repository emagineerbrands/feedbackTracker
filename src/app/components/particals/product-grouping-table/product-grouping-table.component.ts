...
@Component({
  ...
  styleUrls: ['./product-grouping-table.component.css'],
  providers: [NgbCarouselConfig]
})
export class ProductGroupingTableComponent implements OnInit {
  ...
  selectlineItem($event:any, SKU:string, orderNumber: number) {
